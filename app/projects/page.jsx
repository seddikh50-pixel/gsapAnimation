...
const page = () => {
  ...
  const images = [
    ...
    { image1: "/images/nightcity7.png",title1 : "Cyberpunk Futuristic City Streetscape in Action", image2: "/images/nightcity8.jpg",title2 :"Cyberpunk City Street Night With Neon Lights Futuristic Aesthetic" }
  ]
  ...
  return (
    <div className='bg-black  p-4 '>
      ...
      <div className='pt-[50vh]  leading-[0.9]'>
        <h1 className='xl:text-[23vh] text-[6vh] sm:text-[13vh] md:text-[16vh]   text-[#f3e600]  uppercase font-bold'>Night City</h1>
      </div>
